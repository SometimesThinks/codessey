...
| IAM 사용자 | `codyssey-yun` | 삭제 확인 | [02:03:18 사용자 삭제 성공 알림](../../outputs/13_리소스_정리/13_17_IAM_사용자_삭제.png) |
| IAM 사용자 지정 정책 | `codyssey-aws-iam` | 연결 없음 확인 및 사용자 삭제 완료 확인 | [02:03:18 정책 사용 대상 없음](../../outputs/13_리소스_정리/13_17_IAM_사용자_삭제.png) — 정책 삭제 후 화면 미수록 |
...
| 후속 비용 확인 결과 | 미기록 |
| 증빙 경로 | [청구서 예상 총액](../../outputs/13_리소스_정리/13_18_비용_확인.png) |
...
<details>
<summary>17. IAM 사용자 삭제 및 정책 정리 대상 — 이미지 보기</summary>

![IAM 사용자 삭제 및 정책 정리 대상](../../outputs/13_리소스_정리/13_17_IAM_사용자_삭제.png)
...
<details>
<summary>18. 최초 비용 확인 — 이미지 보기</summary>

![최초 비용 확인](../../outputs/13_리소스_정리/13_18_비용_확인.png)
